  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className={`scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl m-4 text-center`}>Modern K.</h1>
        <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl my-4 text-center">&</h1>
        <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl m-4 text-center">Modern K.</h1>
      </div>
    </section>
  );
